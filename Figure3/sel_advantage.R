### plotting selective advantage model results - figure 3C and 3D ###

###history###
# none

### what does this script do?###
#1. Allows user to interactively select files to read .csv outputs from modeling
#2. Rearranges data for plotting
#3. Plots a panel of 3 sub-figures and a heatmap from data
...
sel.adv.data <- file.choose() %>% read.csv() # Myo70COMPLETEwithlowO2growthadvantage.csv
...
low.sel.adv.data <- file.choose() %>% read.csv() # lowoxyfillin.csv
